...
<div class="flex flex-grow">
  ...
  <div class="container mx-auto mt-8 flex-grow p-8 bg-white rounded-lg shadow-lg">
    ...
    <%
      ...
      // Fetch the task object to prefill the form fields
    ...
    <form action="tasks" method="post" class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="text" name="title" id="title" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
        ...
        <div>
          ...
          <input type="date" name="createdate" id="createdate" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                 value="<%= task.getCreationDate().toString() %>" required>
        </div>
        ...
        <div>
          ...
          <input type="date" name="dueDate" id="dueDate" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                 value="<%= task.getDueDate().toString() %>" required>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <textarea name="description" id="description" rows="3" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
            <%= task.getDescription() %>
          </textarea>
        </div>
      </div>
