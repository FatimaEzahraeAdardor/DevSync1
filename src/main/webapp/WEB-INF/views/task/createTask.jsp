...
<div class="flex flex-grow">
    ...
    <div class="container mx-auto mt-8 flex-grow p-8 bg-white rounded-lg shadow-lg">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-4xl font-extrabold text-gray-800">Create New Task</h1>
        </div>
        ...
        <form action="tasks" method="post" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Enter task title" required>
                </div>

                <!-- Task Start Date -->
                <div>
                    <label for="createdate" class="block text-sm font-semibold text-gray-700">Start Date</label>
                    <input type="date" name="createdate" id="createdate" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                </div>
                <!-- Task Status -->
                <div>
                ...
                <div>
                    ...
                    <input type="date" name="dueDate" id="dueDate" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <%
                ...
                <div>
                    ...
                    <select id="tag" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required name="tags[]" multiple="multiple">
                        <%
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Enter task description" required></textarea>
                </div>
            </div>
            ...
            <div class="flex justify-end">
                <button type="submit" class="px-6 py-3 bg-gradient-to-r from-blue-700 to-indigo-700 hover:from-blue-800 hover:to-indigo-800 text-white font-medium rounded-lg shadow-md transition duration-300 ease-in-out">Create Task</button>
            </div>
        </form>
    </div>
</div>
